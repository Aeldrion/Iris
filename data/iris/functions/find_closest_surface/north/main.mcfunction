# Runs iris:find_closest_surface/north/loop for all surfaces with air on the north side

data modify storage iris:data List set from storage iris:block Surfaces.North

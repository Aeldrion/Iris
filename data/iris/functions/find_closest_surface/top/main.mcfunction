# Runs iris:find_closest_surface/top/loop for all surfaces with air on the top side

data modify storage iris:data List set from storage iris:block Surfaces.Top

# Runs iris:find_closest_surface/west/loop for all surfaces with air on the west side

data modify storage iris:data List set from storage iris:block Surfaces.West

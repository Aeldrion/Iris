...
# Add to iris:block (using another storage is needed here as you cannot append several values to a list directly)
data modify storage iris:block Surfaces.Top append from storage iris:data NewSurfaces.Top[]
data modify storage iris:block Surfaces.Bottom append from storage iris:data NewSurfaces.Bottom[]
data modify storage iris:block Surfaces.West append from storage iris:data NewSurfaces.West[]
data modify storage iris:block Surfaces.East append from storage iris:data NewSurfaces.East[]
data modify storage iris:block Surfaces.North append from storage iris:data NewSurfaces.North[]
data modify storage iris:block Surfaces.South append from storage iris:data NewSurfaces.South[]
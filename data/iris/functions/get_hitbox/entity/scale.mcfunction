...
scoreboard players operation $entity_half_width iris /= $10 iris
scoreboard players operation $entity_half_width iris *= $attribute_scale iris
scoreboard players operation $entity_half_width iris /= $100 iris

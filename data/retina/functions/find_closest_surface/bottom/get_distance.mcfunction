#> retina:find_closest_surface/bottom/get_distance
#
...
execute if score $distance retina < $min_distance_to_surface retina run function retina:find_closest_surface/bottom/find_intersection
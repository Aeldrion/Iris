#> retina:find_closest_surface/main
#
...
#	score $min_distance_to_surface retina
...
#	score $closest_cuboid_id retina
...
scoreboard players set $min_distance_to_surface retina 1733
scoreboard players reset $closest_cuboid_id retina

execute if score $dx retina matches 1.. unless score $min_distance_to_surface retina matches 0 run function retina:find_closest_surface/west/main
execute if score $dx retina matches ..-1 unless score $min_distance_to_surface retina matches 0 run function retina:find_closest_surface/east/main
execute if score $dy retina matches 1.. unless score $min_distance_to_surface retina matches 0 run function retina:find_closest_surface/bottom/main
execute if score $dy retina matches ..-1 unless score $min_distance_to_surface retina matches 0 run function retina:find_closest_surface/top/main
execute if score $dz retina matches 1.. unless score $min_distance_to_surface retina matches 0 run function retina:find_closest_surface/north/main
execute if score $dz retina matches ..-1 unless score $min_distance_to_surface retina matches 0 run function retina:find_closest_surface/south/main
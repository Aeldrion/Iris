#> retina:find_closest_surface/north/loop
#
# Determines if the ray hits the current surface
#
# @within retina:find_closest_surface/north/main
...
execute if score ${z} retina < $z0 retina run function retina:find_closest_surface/north/get_distance

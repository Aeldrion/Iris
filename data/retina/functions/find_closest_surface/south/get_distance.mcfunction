#> retina:find_closest_surface/south/get_distance
#
...
execute if score $distance retina < $min_distance_to_surface retina run function retina:find_closest_surface/south/find_intersection
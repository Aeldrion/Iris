#> retina:find_closest_surface/top/loop
#
# Determines if the ray hits the current surface
#
# @within retina:find_closest_surface/top/main
...
execute if score ${y} retina > $y0 retina run function retina:find_closest_surface/top/get_distance
